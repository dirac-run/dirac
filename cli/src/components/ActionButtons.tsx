...
export const ActionButtons: React.FC<{
	...
	// Filter out approve/reject buttons in CLI as they are handled by inline card prompts
	const filteredButtons = uiActionState.globalButtons

	const buttons = filteredButtons
