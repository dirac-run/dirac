...
export class StreamingMetricsManager {
    ...
    updateFromChunk(chunk: UsageChunk): void {
        ...
        this.metrics.reasoningTokens =
            chunk.reasoningTokens ?? chunk.thoughtsTokenCount ?? this.metrics.reasoningTokens
    ...
    async updateApiReqMsgFromMetrics(
        ...
        const contextUsagePercentage = contextWindow
