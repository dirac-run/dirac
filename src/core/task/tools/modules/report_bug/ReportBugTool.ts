    ...
    private async validateParameters(args: any, env: IToolEnvironment): Promise<any | null> {
        ...
        for (const param of requiredParams) {
            if (!args[param]) {
                ...
                await env.ui.upsertText(`Dirac tried to use ${DiracDefaultTool.REPORT_BUG} without providing a value for '${param}'. Retrying...`)
