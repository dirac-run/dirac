...
const TaskHeader: React.FC<TaskHeaderProps> = ({ task, totalCost, cacheHitRate, lastApiReqInfo, onClose, onSendMessage }) => {
	const {
		apiConfiguration,
		currentTaskItem,
			...
			<div
				...
				<div
					...
					<div className="inline-flex items-center justify-end select-none shrink-0 gap-2">
						...
						{cacheHitRate > 0 && (
							<div
								className="px-2 py-1 rounded-md bg-foreground/5 text-xs font-mono border border-foreground/5 font-bold"
