...
const DiracModelPicker: React.FC<DiracModelPickerProps> = ({ isPopup, currentMode, showProviderRouting }) => {
	...
	const { selectedModelId, selectedModelInfo } = useMemo(() => {
		...
		if (freeDiracModelIdSet.has(normalizeModelId(selected.selectedModelId))) {
			return {
				...selected,
				selectedModelInfo: {
		...
		return selected
	}, [apiConfiguration, currentMode, freeDiracModelIdSet])
	...
	const modelIds = useMemo(() => {
		...
		return filterOpenRouterModelIds(unfilteredModelIds, "dirac", freeDiracModelIds)
	}, [diracModels, freeDiracModelIds])
...
export default DiracModelPicker
