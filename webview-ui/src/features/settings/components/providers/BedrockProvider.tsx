		...
		<div className="flex flex-col gap-1">
			...
			{(apiConfiguration?.awsAuthentication === undefined && apiConfiguration?.awsUseProfile) ||
				...
				<DebouncedTextField
					...
					key="profile"
					onChange={(value: string) => handleFieldChange("awsProfile", value)}
				...
				<DebouncedTextField
					...
					key="apikey"
					onChange={(value: string) => handleFieldChange("awsBedrockApiKey", value)}
				...
				<>
					<DebouncedTextField
						...
						key="accessKey"
						onChange={(value: string) => handleFieldChange("awsAccessKey", value)}
					...
					<DebouncedTextField
						...
						onChange={(value: string) => handleFieldChange("awsSecretKey", value)}
					...
					<DebouncedTextField
						...
						onChange={(value: string) => handleFieldChange("awsSessionToken", value)}
